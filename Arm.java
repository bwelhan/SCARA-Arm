...
public class Arm
{
   ...
   public void directKinematic(){
    ...
    public void inverseKinematic(double xt_new,double yt_new){
        ...
        // elbows positions
        xj1 = xm1 + 0.5*(xt-xm1) + h1*Math.cos(Math.PI/2 - alpha1);
        yj1 = ym1 + 0.5*(yt-ym1) + h1*Math.sin(Math.PI/2 - alpha1);
        ...
        // elbows positions
        xj2 = xm2 + 0.5*(xt-xm2) - h2*Math.cos(Math.PI/2 - alpha2);
        yj2 = ym2 + 0.5*(yt-ym2) - h2*Math.sin(Math.PI/2 - alpha2);
